----------------------------------------------------------------------------------
-- Source: https://gist.github.com/Zehkul/25ea7ae77b30af959be0
-- Usage : alt + w activates the script. First activation marks one end of the clip,
--         the second one the other, order does not matter.
----------------------------------------------------------------------------------
...
local options = {
    ...
    use_same_dir = true,			-- puts the output files where the original video was
